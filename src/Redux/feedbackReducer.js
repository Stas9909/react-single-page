...
let initialState = {
    FeedbackTemplate: [
        {id: 1, revievLogo: tourist1, txtReview: "Спасибо огромное команде Tours&Tickets за прекрасно подобранный тур и великолепный отдых.Огромное спасибо персональному менеджеру Лидии за правильно рекомендованный отель по моему запросу ,а также за внимание и понимание !!!", dateReview: "08 червня 2022"},
        {id: 2, revievLogo: tourist2, txtReview: "Буквально вчора повернулася з відпочинку з Єгипту, тур замовляли в Tours&Tickets, і хочу вам сказати, що я рекомендую 💯. Ми залишились задоволені і відпочинком і організацією туру. Все швидко, професійно, надійно. Тепер я ваш постійний клієнт однозначно. Ще раз вам величезне дякую", dateReview: "26 cічня 2022"},
        ...
        {id: 4, revievLogo: tourist4, txtReview: "Спасибо огромное команде Tours&Tickets за прекрасно подобранный тур и великолепный отдых.Огромное спасибо персональному менеджеру Лидии за правильно рекомендованный отель по моему запросу ,а также за внимание и понимание !!!", dateReview: "17 грудня 2021"},
    ],
    NewFeedbackText: ""
}
